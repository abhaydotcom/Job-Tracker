...
import { Board, Columns, JobApplication } from "../Models/Models.types";
import { updateJobApplication } from "../actions/job-application-data";

export function useBoard(initialBoard?: Board | null) {
  const [board, setBoard] = useState<Board | null>(initialBoard || null);
  const [columns, setColumns] = useState<Columns[]>(initialBoard?.columns || []);
